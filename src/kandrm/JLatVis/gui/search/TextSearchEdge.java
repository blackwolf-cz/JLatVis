 ...
 * @author Michal Kandr
 */
public class TextSearchEdge extends javax.swing.JDialog {
     ...
     * @param search
     */
    public TextSearchEdge(java.awt.Frame parent, TextSearch search) {
        super(parent, false);
        initComponents();
        this.search = search;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Edge text search");

        jPanel1.setPreferredSize(new java.awt.Dimension(270, 53));
        ...
        commentField.setMinimumSize(new java.awt.Dimension(200, 20));
