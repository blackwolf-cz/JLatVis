...
import kandrm.JLatVis.lattice.editing.history.HistoryEventNodeNamePosition;
 ...
 * @author Michal Kandr
 */
public class NodeNameMover extends MouseAdapter implements IHistoryEventSender {
    ...
    public NodeNameMover(LatticeShape latticeShape){
    ...
    public void mouseReleased(MouseEvent e) {
        if(movedTag != null){
            fireHistoryEvent(new HistoryEventNodeNamePosition(movedTag, originalDistance, originalAngle,
    ...
    private void selectMovedName(MouseEvent e){
        movedTag = (NodeNameShape) e.getSource();
    ...
    private void moveName(MouseEvent e){
    ...
    public void mouseDragged(MouseEvent e) {
        if( ! ( e.getSource() instanceof NodeNameShape)){
            return;
        }
        if(movedTag == null){
            selectMovedName(e);
